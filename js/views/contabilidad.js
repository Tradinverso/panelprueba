...
function renderResumen() {
  ...
  return `
    <div class="kpi-grid">
      ...
      ${kpiCard({ label: 'Payout medio / cuenta', value: s.evaluaciones > 0 ? fmtUsd(s.gananciasNetas / s.evaluaciones) : '–', sub: `payouts netos ÷ ${s.evaluaciones} cuenta${s.evaluaciones !== 1 ? 's' : ''}`, tone: 'green', icon: '💸' })}

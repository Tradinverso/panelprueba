...
export const ICONS = {
  ...
  // Backtesting: matraz de laboratorio (probar la operativa antes del dinero real)
  backtest:  svg('<path d="M10 2v6L4.5 18a2 2 0 0 0 1.8 3h11.4a2 2 0 0 0 1.8-3L14 8V2"/><path d="M8.5 2h7"/><path d="M7 15h10"/>'),
